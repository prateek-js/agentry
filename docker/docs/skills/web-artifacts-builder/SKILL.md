...
This creates `bundle.html` — a self-contained artifact with all JavaScript, CSS, and dependencies inlined. The user can open it directly in a browser or share it from the sandbox via the dashboard's Share button.
